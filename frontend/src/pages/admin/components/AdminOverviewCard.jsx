...
const AdminOverviewCard = ({ handleDownloadReport, downloading }) => {
  return (
    <Card className="bg-payfile-maroon p-6 md:p-8 h-full flex flex-col justify-between text-white border-none shadow-xl shadow-payfile-maroon/20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-32 h-32 bg-payfile-gold/10 blur-3xl rounded-full" />
        
        <div className="relative z-10">
            <h3 className="text-2xl font-black mb-4 !text-white tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Overview</h3>
