...
const SaleModal = ({ 
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      title="Sell File"
      description={`Set your price and BTC payout address for ${saleFile?.name}`}
      maxWidth="max-w-xl"
    >
        <form className="space-y-6" onSubmit={handleCreateListing}>
            <div className="grid grid-cols-2 gap-6">
                <div className="space-y-3">
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Price (BTC)</label>
                    <input
                        type="text"
                        required
                ...
                <div className="space-y-3 flex items-end pb-1">
                    <div className="w-full py-4 rounded-2xl text-xs font-black bg-payfile-maroon text-white text-center tracking-widest">
                        Bitcoin (BTC)
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-3">
                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">BTC Payout Address</label>
                <input
                    type="text"
                    required
                    placeholder="bc1q..."
